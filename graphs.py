...
plt.legend()
plt.grid()
plt.savefig("average_success.png")
plt.show()

# Grafico per il costo medio
plt.figure(figsize=(12, 6))
plt.plot(data['NumberOfClients'], data['AverageCostGreedyDistance'], label='Average Cost Greedy Distance', marker='o')
plt.plot(data['NumberOfClients'], data['AverageCostGreedyCDF'], label='Average Cost Greedy CDF', marker='o')
